"""BalancedScorecard URL Configuration
...
from BalancedScorecard.views import Inicio,CargaDataset, DescargaDataset, Estadisticas, PlantillaPowerBi, CerrarPrograma, OptimizarDataset, CargaCompletada
